...
```{r}
ntankro_240813 <- read.csv("/ntankro_mod_pm/DATA_20240813@FW22", skip = 4, header = TRUE)[, 1:3]

ntankro_240814 <- read.csv("/ntankro_mod_pm/DATA_20240813@FW22", skip = 4, header = TRUE)[, 1:3]
